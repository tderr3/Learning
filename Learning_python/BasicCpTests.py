...
from RackCpTest import test_001_Basic_rack_pattern
from FlexCpTest import test_002_Basic_flex_pattern
...
runner = HtmlTestRunner.HTMLTestRunner(output = 'c:\\python34\\testResults\\')
